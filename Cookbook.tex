...
\begin{recipe}{Tiramisu}{Trevor and Zoe Taylor}{1 Hour; 12 Servings}
    ...
    \Ing{1 Cup Espresso}
    \Ing{Liqueur (Madeira Wine), to taste}
    \Ing{1 Package Ladyfingers}
